...
class AudioStream {
 public:
  AudioStream(const std::string& task_id) : is_pause_{false}, is_cancel_{false}, is_running_{true}, task_id_(task_id), sndfile_{nullptr}, stream_{nullptr} {}
 ...
 protected:
  ...
  static void stream_state_callback(pa_stream* s, void* userdata) {
    ...
    switch (pa_stream_get_state(s)) {
      ...
      default:
        LOG(ERROR) << thiz->task_id_ << ",stream error:" << pa_strerror(pa_context_errno(pa_stream_get_context(s)));
        break;
    }
  }
