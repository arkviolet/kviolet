...
class HTTPClient {
 ...
 public:
  ...
  void SetProxy(std::string host, std::string user, std::string pass,
                curl_proxytype type = CURLPROXY_HTTP);
 ...
 protected:
  ...
  static std::size_t WriteFunction(void *buffer, std::size_t size,
                                   std::size_t nmemb, void *stream);

  static std::size_t HeaderFunction(void *buffer, std::size_t size,
                                    std::size_t nmemb, void *stream);

  static size_t AskHeaderFunction(CURL *handle, curl_infotype type,
                                  void *buffer, size_t size, void *stream);
