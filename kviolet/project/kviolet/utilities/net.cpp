...
namespace kviolet
{
    ...
    bool Net::SetSendTimeout(int32_t sock, std::time_t second)
    {
        ...
        return setsockopt(sock, SOL_SOCKET, SO_SNDTIMEO, reinterpret_cast<const char *>(&timeout), sizeof(timeout)) ==
               0;
    }
    ...
    bool Net::SetReceiveTimeout(int32_t sock, std::time_t second)
    {
        ...
        return setsockopt(sock, SOL_SOCKET, SO_RCVTIMEO, reinterpret_cast<const char *>(&timeout), sizeof(timeout)) ==
               0;
    }
    ...
    int32_t Net::GetSendBufferSize(int32_t sock)
    {
        ...
        return getsockopt(sock, SOL_SOCKET, SO_SNDBUF, reinterpret_cast<char *>(&optionValue), &optionLength) == 0
               ? optionValue : -1;
    }
    ...
    int32_t Net::GetReceiveBufferSize(int32_t sock)
    {
        ...
        return getsockopt(sock, SOL_SOCKET, SO_RCVBUF, reinterpret_cast<char *>(&optionValue), &optionLength) == 0
               ? optionValue : -1;
    }
