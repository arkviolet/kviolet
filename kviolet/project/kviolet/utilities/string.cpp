...
namespace kviolet
{
    ...
    std::string String::Replace(const std::string &value, const std::string &src,
    ...
    std::string String::ReplaceAll(const std::string &value, const std::string &src,
                                   const std::string &dst, std::size_t index)
    {
        std::string str = value;
    ...
    std::size_t String::Split(const std::string &value, const std::string &key,
                              std::vector<std::string> &container, bool keepEmpty)
    {
        if (key.empty())
        {
