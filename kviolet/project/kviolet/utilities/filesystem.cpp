...
namespace kviolet
{
    ...
    void Filesystem::TraverseFile(const std::string &path,
                                  std::vector<std::string> &container, const std::regex &rule, bool subdirectory)
    {
        DIR *dir = opendir(path.c_str());
    ...
    std::vector<std::string> Filesystem::TraverseFile(const std::string &path,
                                                      const std::regex &rule, bool subdirectory)
    {
        std::vector<std::string> container;
    ...
    void Filesystem::TraverseDirectory(const std::string &path,
                                       std::vector<std::string> &container, const std::regex &rule, bool subdirectory)
    {
        DIR *dir = opendir(path.c_str());
    ...
    std::vector<std::string> Filesystem::TraverseDirectory(const std::string &path,
                                                           const std::regex &rule, bool subdirectory)
    {
        std::vector<std::string> container;
